...
async def analyze_and_store(content: str, db: AsyncSession) -> JournalEntry:
    top_behaviors, emotional_profile, emotional_shift_summary, sentiment_label = await analyze_sentences(content)
    ...
    journal = JournalEntry(
        ...
        emotional_shift_summary=emotional_shift_summary,
